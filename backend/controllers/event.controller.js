...
const gen_url = () => {
    ...
    const url = `/ux/web-schedules/v2/schedules/classes?start=${oneWeekFormatted[0]}%2F${oneWeekFormatted[1]}%2F${oneWeekFormatted[2]}&end=${twoWeeksFormatted[0]}%2F${twoWeeksFormatted[1]}%2F${twoWeeksFormatted[2]}&tags=interest%3APickleball&tags=format%3AClass&locations=Sky%20(Manhattan)&locations=PENN%201&isFree=false&isLiveStreaming=false&facet=tags%3Ainterest%2Ctags%3AdepartmentDescription%2Ctags%3AtimeOfDay%2Ctags%3Aage%2Ctags%3AskillLevel%2Ctags%3Aintensity%2Cleader.name.displayname%2Clocation.name%2Ctags%3Aresource&page=1&pageSize=750`
    return url;
}
